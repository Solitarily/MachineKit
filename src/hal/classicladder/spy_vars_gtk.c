...
void OpenSpyVarsWindow( )
{
	...
	case 0 :	gtk_widget_show( SpyBoolVarsWindow ); gtk_widget_hide( SpyFreeVarsWindow );
			MessageInStatusBar(_("openned BOOL (bit) variable window. press again for WORD window"));	
		break;
	case 1 :        gtk_widget_hide( SpyBoolVarsWindow ); gtk_widget_show( SpyFreeVarsWindow );
			MessageInStatusBar(_("openned WORD (s32) variable window. press again for both windows"));
		break;
	case 2 :	gtk_widget_show( SpyBoolVarsWindow ); gtk_widget_show( SpyFreeVarsWindow );
			MessageInStatusBar(_("openned BOTH variable windows. press again to close them."));
		break;
